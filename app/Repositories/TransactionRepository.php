<?php 
    ...
    {
        public function getTransactionDateFromSession()
        {
        ...
        private function calculateSubtotal($flightClassId, $sumberOfPassengers)
        {
            $price = FlightClass::findOrFail($flightClassId)->price;
            return $price * $sumberOfPassengers;
        }

        private function applyPromoCode($data)
        {
            $promo = PromoCode::where('codee', $data['promo_code'])
